...
public class Controller extends JApplet {
	...
	public void playARound() {
		...
		if (currentRound == ROUND) {
			...
			{
				result = "Winner is Player "+String.valueOf(winner.getId()+1);
			}
	...
	public void initTable()
	{
		...
		{
			String [] coloumTitle = {"Player","Score","P/L"};
			dtm = new DefaultTableModel(coloumTitle,0);
			infoTable.setModel(dtm);
			for(int i=0;i<playerList.size();i++)
			{
	...
	private void createGUI() {
		...
		this.getContentPane().setSize(800, 700);
		...
		operPanel.setPreferredSize(new Dimension(300,165));
		...
		gamblePanel.setPreferredSize(new Dimension(300,435));
		...
		showPanel.setPreferredSize(new Dimension(520,150));
		barPanel.setPreferredSize(new Dimension(520,550));
		...
		for (int i = 0; i < GABMLE_NUM; i++) {
			...
			JSlider barPlayer1 = new JSlider(JSlider.HORIZONTAL, BAR_MIN,
					BAR_MAX, BAR_INIT);
			...
			JSlider barPlayer2 = new JSlider(JSlider.HORIZONTAL, BAR_MIN,
					BAR_MAX, BAR_INIT);
